...
class NetworkToolsApp:
    def __init__(self, root):
        try:
            ...
            self.entry_ping_ip = ttk.Entry(self.tab_ping, width=30, style="TEntry")
            self.entry_ping_ip.pack(pady=10)
            ...
            self.label_tracert_ip.pack(pady=10)

            self.entry_tracert_ip = ttk.Entry(self.tab_traceroute, width=30, style="TEntry")
            self.entry_tracert_ip.pack(pady=10)
            self.entry_tracert_ip.insert(0, "8.8.8.8")  # Vorbelegen mit 8.8.8.8
            self.entry_tracert_ip.focus_set()
            self.entry_tracert_ip.bind("<Return>", lambda e: self.start_ping())
